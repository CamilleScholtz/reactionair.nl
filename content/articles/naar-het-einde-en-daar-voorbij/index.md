...
Het eerste geval deed zich voor bij het bepophkijken van een video van _Aarvoll_,[^1] waarin hij het volgende idee naar voren brengt:
...
>When we are discussing the term [infinite], we are asking _“does this apply to the universe?”_, and if it does apply, there are all sorts of contradictions that we're going to run into immediately; one of them being, “can the infinite be finite?”... No, clearly that violates the law of identity, but then you are saying _“the infinite is limited to the metalogical laws”_. This is really just a variant of the problem of omnipotence; _“can God create a boulder so large he can't lift it?”_. That is saying, is the omnipotent force capable of rendering itself not omnipotent? Can omnipotence  negate its identity? or is it restricted by its identity and therefore not fully omnipotent because it can't overcome that identity.
