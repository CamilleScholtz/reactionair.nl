...
\[^7\]: Ibid.
\[^8\]: Respectievelijk: [_Yuja Wang - Carmen Variations (Bizet Horowitz)_](https://www.youtube.com/watch?v=e28xOQYYAWI) en [_Vladimir Horowitz - Variation on a theme of Bizet's_](https://www.youtube.com/watch?v=WV_Nh884PKg).
...
\[^11\]: De staat van het atheïsme opgesomd: [_Atheist - Second to Sun_](https://www.youtube.com/watch?v=T5GqPol2wcA).
\[^12\]: Het artikel dat ik als bron heb gebruikt en u maar al te graag aanbeveel voor verdieping: [_After the War_](https://pjb.com.au/mus/after_the_war.html).
\[^13\]: Alex Rosse, _The Rest is Noise_.
\[^14\]: John Borstlap, [_Het FPK is niet voor haar taak geschikt_](http://johnborstlap.com/het-fpk-is-niet-voor-haar-taak-geschikt/).